...
{
    public class MovingState : GameState, IEventSubscriber<OnVictory>, IEventSubscriber<OnDeath>
    {
        ...
        public void OnEvent(OnVictory eventData) => stateSwitcher.SetState(GameStateType.Victory);

        public void OnEvent(OnDeath eventData) => stateSwitcher.SetState(GameStateType.Loss);
