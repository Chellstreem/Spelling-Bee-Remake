...
namespace GameStates
{
    public abstract class SpawnStateDefinition : GameStateDefinition
    {
        ...
        [Tooltip("Spawn flow configurations used by this state to configure which units spawn and their timing")]
        [SerializeField] protected SpawnFlowInfo[] _spawnFlowInfos;

        public override GameState CreateGameState() => new SpawnState(this);
